...
export const ALL_MENU_SECTIONS: MenuSection[] = [
  ...
  // 11. System Settings (Owner/Super Admin only)
  {
    ...
    items: [
      ...
      { icon: Shield, label: "Permission Plans", labelAr: "خطط الصلاحيات", path: "/permission-plans" },
      { icon: Shield, label: "User Overrides", labelAr: "استثناءات المستخدمين", path: "/user-permission-override" },
